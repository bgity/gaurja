...
{ 
  ...
  $service_image= $file_name;
           ...
           $sql="INSERT INTO services(service_name,service_details,service_image)VALUES('".$service_name."','".$service_details."','".$service_image."')";
		...
		<div class="container-fluid">
			...
			<div class="row heading-bg">
				<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
					<h5 class="txt-dark">Add Service</h5>
				</div>
				...
				<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
					<ol class="breadcrumb">
						...
						<li class="active"><span>Add Service</span></li>
					</ol>
				</div>
				<!-- /Breadcrumb -->
														...
														<div class="form-group">
															...
															<div class="col-sm-9">
																<div class="input-group">
																	...
																	<textarea rows="10" cols="30" class="ckeditor" id="editor1" name="service_details" class="requiredField" required ></textarea> 
																	<div class="input-group-addon"><i class="icon-lock"></i></div>
																</div>
															</div>
														</div>
														<div class="form-group">
															<label  for="exampleInputpwd_6" class="col-sm-3 control-label">Service Image*</label>
															<div class="col-sm-9">
																<div class="input-group">
																	<input type="file" class="dropify" name="service_image" required="">
