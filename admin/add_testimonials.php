                                ...
                                <div class="col-sm-12 col-xs-12">
                                    <div class="form-wrap">
                                        <form class="form-horizontal" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <label for="exampleInputEmail_4" class="col-sm-3 control-label">Country
                                                    Name</label>
                                                <div class="col-sm-9">
                                                    <div class="input-group">
                                            ...
                                            <div class="form-group">
                                                <label for="exampleInputpwd_6"
                                                    class="col-sm-3 control-label">Testimonials*</label>
                                                <div class="col-sm-9">
                                                    <div class="input-group">
                                                        ...
                                                        <textarea rows="10" cols="30" class="ckeditor" id="editor1"
                                                            name="content" class="requiredField" required></textarea>
                                                        <div class="input-group-addon"></div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="input-group">
                                                        <input type="file" class="dropify" name="testimonials_image"
                                                            required="">
                                                        <div class="input-group-addon"><i class=""></i></div>
                                                    </div>
                                                </div>
