...
if (isset($_POST['submit']))
{
 ...
 $testimonials_image =$save_image.$testimonials_image_name; 
 		 ...
 		 $result7 ="UPDATE tbl_testimonials SET name='$name',country_name='$country_name',content='$content',testimonials_image ='$testimonials_image' WHERE id='$id' " ;
...
{ 
  ...
  $testimonials_image= $file_name;
  		...
  		$result8 ="UPDATE tbl_testimonials SET name='$name',country_name='$country_name',content='$content' WHERE id='$id' " ;
...
$id = $_GET['id'];
$result ="SELECT * FROM tbl_testimonials WHERE id='$id' ";
       ...
       while($res = $stmt1->fetch(PDO::FETCH_ASSOC))
         {
          ...
          $content=$res['content'];
          $testimonials_image = $res['testimonials_image'];
         }
												...
												<div class="form-wrap">
													<form class="form-horizontal" method="POST" enctype="multipart/form-data" >
														...
														<div class="form-group">
															...
															<div class="col-sm-9">
																<div class="input-group">
																	<input type="text" class="form-control" name="country_name" value="<?php echo $country_name;?>" placeholder="Enter Country Name" required="">
														...
														<div class="form-group">
															<label  for="exampleInputpwd_6" class="col-sm-3 control-label">Content*</label>
															<div class="col-sm-9">
																<div class="input-group">
																	<!-- <textarea class="summernote"  name="post_content" placeholder="Enter Video Description" rows="5" cols="50" required=""> </textarea> -->
																	<textarea rows="10" cols="30" class="ckeditor" id="editor1" name="content" value="<?php echo $content;?>" class="requiredField" ><?php echo $content;?></textarea> 
																	<div class="input-group-addon"></div>
																</div>
															</div>
														</div>
														<div class="form-group">
															...
															<div class="col-sm-9">
																<div class="input-group">
																	<input type="file" id="image" class="dropify" name="testimonials_image" value="<?php echo $testimonials_image;?>">
																	<div class="input-group-addon"><i class=""></i></div>
																</div>
																<br>
																	 <img class="zoom" id="testimonials_image"  src="<?php echo $testimonials_image;?>" height="150" width="150" />
															</div>
														</div>
