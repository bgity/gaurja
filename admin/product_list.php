										...
										<div class="table-responsive">
											...
											<?php
									             $count_id = '1';
									               ...
									               echo substr($row['product_details'], 0, 500);     
									                    ?></td>
									                     <td><img src=<?php echo $row['product_image']; ?> alt='post image' width='80px' height='80px'></td>
									                   
									                    <td><a href="edit_product.php?id=<?php echo $row['id'];?>"><i class='fa fa-pencil'></i> | <a href="delete_product.php?id=<?php echo $row['id'];?>" onClick="return confirm('Are you sure you want to delete?')"><i class='fa fa-trash'></i></a></a></td>
