        ...
        <div class="row">
            ...
            <div class="card-main-div col-md-12 col-sm-12 col-xs-12">
                <div class="card-div thumbnail">
                    <img src="admin/<?php echo $row4['testimonials_image']; ?>" alt="Nature" class="img-raised">
                    <h1 class=" testamonial-text"><?php echo $row4['name']; ?></h1>
                    <p class="testamonial-description"><?php echo $row4['content']; ?></p>
                </div>
            </div>
            <?php } ?>
        </div>
