    ...
    <section class="service-style-3">
    	<div class="auto-container">
        	...
        	<div class="row">
                        ...
                        <?php 
                        $id = $_GET['id'];
                        $sql4="select * from tbl_franchise where id = '$id' ";
                    ...
                    <?php }?>
                        ...
                        <div class="pricing-column">
                            <a href="" class="theme-btn btn-style-one" style="width:100%"><?php echo $row4['store_name']; ?></a>
                             <a href="" class="theme-btn btn-style-one" style="width:100%"><?php echo $row4['store_location']; ?></a>
                            </div>
                        <p><?php echo $row4['store_details']; ?></p>
